    ...
    <div>
        ...
        <GSAPScrollSmoother>
            ...
            <div class="main_content_container">
                ...
                <h3 class="welcome_text">Update Password</h3>
                <p class="welcome_subtext">Set a new password</p>
...
function welcome_submit(route_to) {
...
function submit_password() {
   ...
   method: 'POST',
        ...
        body: JSON.stringify({ivid: ivid.value, password: password.value, pass_method:'update_the_pass'})
