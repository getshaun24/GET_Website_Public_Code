    ...
    <div class="dark_mode" style="overflow-x:hidden">
        ...
        <GSAPScrollSmoother>
            ...
            <div class="navigation_header">
                <div class="nav_menu_title">Your Legal Documents</div>
            ...
            <div class="dashboard_inner_section">
                <div class="main_content_container">
                    ...
                    <!-- <InvestorDashInfoTableAgreements v-bind="table_data_list"/> -->
...
onBeforeMount(() => { if (authCookieRefresh()) {get_agreements()} })

        
const cookie_options = {default:()=> '', watch:true, maxAge:1800}
const investor_ID = useCookie('investor_ID', cookie_options)

console.log(investor_ID.value)
const active_page = {is_active: "agreements_active"}

// ---------------------  Table Component Data --------------------- //
const table_name = ref('Agreements')
const table_row_style = ref('agreements_table')
const table_headers = ref(['Fund Name', 'Date', 'Sub Agreement', 'Operating Agreement'])
...
fetch(`${config.flask_url}/api/investor_dashboard/agreements/`, {
    method: 'POST',
    mode: 'cors',
    headers: {
