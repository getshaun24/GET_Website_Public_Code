...
<div class="remove_mix_mode">
    ...
    <div class="success_card">
        ...
        <div class="success_inner_container">
            ...
            <h5 class="success_message">Please check your email for the order confirmation and make sure to select the link to initiate your account and track your investments.
        </h5>
...
sleep(1800000).then(() => { investor_ID.value = null; fund_ID.value = null; investment_amount.value = null; timer_status.value = null; number_of_transfers.value = null; selected_fund.value = null; navigateTo('/') })
