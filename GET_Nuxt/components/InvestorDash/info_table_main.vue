<template>
    <div class="container_table">      
        <p style="color:#fff">{{ table_name }}</p>
        <table class="table">
            <thead >
        ...
        <InvestorDashTableRowsOverviewTable v-if="table_row_style == 'overview_table'" :col_num="col_num" :counter_index="counter_index" :show_amount="show_amount"/>
        <InvestorDashTableRowsTransactionsTable v-if="table_row_style == 'transactions_table'" :col_num="col_num" :counter_index="counter_index" :show_amount="show_amount"/>
        <InvestorDashTableRowsAgreementsTable v-if="table_row_style == 'agreements_table'" :col_num="col_num" :counter_index="counter_index" :show_amount="show_amount"/>
        <InvestorDashTableRowsNotificationsTable v-if="table_row_style == 'notifications_table'" :col_num="col_num" :counter_index="counter_index" :show_amount="show_amount"/>
