<template>
                ...
                <tr v-for="row in table_data.investor_data" class="table_row">
                    <td v-for="(value, index) in row" class="table_data">
                        ...
                        <div v-else-if="table_data.has_status == true && index == 1" class="flex_status">
                            <div class="status_color_circle status_color_orange"></div>
    ...
    console.log(props.table_data.investor_data)

    // if (props.value.fund_ID ==  'a7959f1c-365a-58aa-a781-cec4d84e6b27'){
    //     console.log('xxx')
    // }
