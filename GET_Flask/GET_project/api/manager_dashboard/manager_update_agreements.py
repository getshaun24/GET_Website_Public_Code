...
GET_manager_update_agreements_Blueprint = Blueprint('GET_manager_update_agreements', __name__)
@GET_manager_update_agreements_Blueprint.route('/api/manager_dashboard/manager_update_agreements/', methods=['GET', 'POST']) # <- from '/'
@jwt_required()
def GET_manager_update_agreements():
