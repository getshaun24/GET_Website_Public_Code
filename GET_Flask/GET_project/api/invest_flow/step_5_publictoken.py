...
from GET_project.api.plaid import plaid_client, get_plaid_auth, get_plaid_income
from GET_project import db


GET_invest_flow_step_5_publictoken_Blueprint = Blueprint('GET_invest_flow_step_5_publictoken', __name__)
@GET_invest_flow_step_5_publictoken_Blueprint.route('/api/invest_flow/step_5_publictoken/', methods=['GET', 'POST']) # 


def GET_invest_flow_step_5_publictoken():
